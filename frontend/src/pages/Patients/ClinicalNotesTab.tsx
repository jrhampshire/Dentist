...
import { useClinicalNotes, useCreateClinicalNote, useSignClinicalNote } from '@/hooks/useClinicalNotes'
...
export function ClinicalNotesTab({ patientId }: ClinicalNotesTabProps) {
  ...
  const getTypeBadge = (type: NoteType) => {
    const variants: Record<NoteType, 'info' | 'success' | 'warning' | 'secondary' | 'default'> = {
      evolution: 'info',
      diagnosis: 'warning',
      treatment: 'success',
